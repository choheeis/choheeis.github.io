...
- 정렬되지 않은 배열 {4, 2, 10, 6, 9, 46, 7, 28} 을 합병 정렬 알고리즘을 이용해서 정렬해보자.
	...
	그럼 위와 같은 방법으로 왼쪽 배열의 3과 오른쪽 배열의 2를 비교하여 작은 수를 sort 배열에 넣고, 선택된 배열의 피봇을 1 증가시킨다.
	...
	이 경우가 되면 첫 번째 while문을 빠져나와 두 번째 or 세 번째 while문이 실행된다.
...
- _흠.... 시간복잡도가 O(nlogn)인데 왜 nlogn인지를 구글링해봐도 잘 모르겠네 밤이라 그런가 머리가 안돌아가지?! 

<br>

![합병정렬10](https://user-images.githubusercontent.com/31889335/57085941-2baf0f80-6d38-11e9-91d2-4522cec84439.png)
